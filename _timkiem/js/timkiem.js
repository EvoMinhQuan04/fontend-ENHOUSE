...
var ws = url.searchParams.get('input');
var hienthiSearch = document.getElementById('hienthi');
hienthiSearch.innerHTML = '<p class="tukhoa">'+ ws + '</p>'
console.log(ws,hienthiSearch)
